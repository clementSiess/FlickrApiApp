...
class ImageCache {
  ...
  func imageForKey(key: String) -> UIImage? {
    ...
    init() {
        NSNotificationCenter.defaultCenter().addObserverForName(UIApplicationDidReceiveMemoryWarningNotification, object: nil, queue: NSOperationQueue.mainQueue()) { notification in
